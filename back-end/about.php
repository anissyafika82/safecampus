...
<ul style="list-style: none; padding-left: 0; text-align: center;">
    ...
    <li><b>NORSHAMIERA BINTI MAT ZIN (2023)</b></li>
    <li><b>AINAA' AMANI BINTI HATTA(2023)</b></li>
</ul>

    <p>© 2026 SafeCampus Project</p>

    <a href="https://github.com/your-repo-link" class="btn-custom">View GitHub Project</a>
    <br>
    <a href="dashboard.php" class="home-link">Back to Dashboard</a>
</div>
